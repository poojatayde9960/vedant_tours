...
const FlightListing = () => {
  ...
  return (
    <div className="mt-72 p-4 md:p-8 md:mt-36 font-poppins min-h-screen relative">
      {/* Sticky Header */}
      <div className="sticky top-[64px] md:top-[80px] bg-white z-30 -mx-4 md:-mx-8 px-4 md:px-8 py-4 border-b shadow-sm">
        <div className="flex items-center justify-between text-center">
          ...
          <div className="flex flex-col md:flex-row items-center w-full md:w-auto md:justify-between flex-1 md:ml-[17%] gap-4">
            ...
            <div className="flex bg-white rounded-lg border p-1 text-[14px]">
              ...
              <button className="md:px-4 md:py-2 px-2 py-1 text-sm hover:bg-gray-100 transition">
                Others
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <div className="w-full lg:w-1/5">
          ...
          <div
            className="flex items-center justify-between md:hidden mb-2 p-2 bg-white rounded-xl shadow-sm cursor-pointer"
          ...
          {/* Mobile Filters */}
          <div className={`${showMobileFilters ? "block" : "hidden"} md:hidden space-y-4`}>
            <BudgetFilter />
...
const FlightCard = ({ navigate }) => (
  <div className="bg-white rounded-xl border border-[#0061E030] p-4 space-y-4 cursor-pointer hover:shadow-lg transition duration-300">
    <div className="grid grid-cols-2 md:flex justify-between w-full items-center gap-4">
      ...
      <button
        className="mt-2 bg-[#00357A] text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700"
